package Wipro.MiniProjects.EmployeePro;

public class Employee {
    public static void main(String[] args) {
        if (args.length == 0) {
            System.out.println("Please provide EmpNo as a command line argument.");
            return;
        }
        ...
        char[] designCodes = {'e', 'c', 'k', 'r', 'm', 'e', 'c'};
        String[] departments = {"R&D", "PM", "Acct", "Front Desk", "Engg", "Manufacturing", "PM"};
        int[] basics = {20000, 30000, 10000, 12000, 50000, 30000, 29000};
        int[] hras = {8000, 12000, 8000, 6000, 20000, 12000, 10000};
        int[] its = {3000, 9000, 1000, 2000, 20000, 4000, 10000};
        ...
        for (int i = 0; i < empNos.length; i++) {
            if (empNos[i] == inputEmpNo) {
                found = true;

                switch (designCodes[i]) {
                    case 'e':
                ...
                System.out.println(empNos[i] + "\t" + empNames[i] + "\t\t" + departments[i] + "\t\t" + designation + "\t" + salary);
                break;
            }
        }
